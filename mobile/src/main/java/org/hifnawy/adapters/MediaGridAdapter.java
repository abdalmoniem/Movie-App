...
public class MediaGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private MediaGridAdapter.OnItemLongClickListener mItemLongClickListener;
    ...
    public void setOnItemLongClickListener(MediaGridAdapter.OnItemLongClickListener listener) {
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, Media item, int position);
    }
    public interface OnItemLongClickListener {
        boolean onItemLongClick(View view, Media item, int position);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            if (mItemLongClickListener != null) {
                ...
                return mItemLongClickListener.onItemLongClick(view, item, position);
            }
