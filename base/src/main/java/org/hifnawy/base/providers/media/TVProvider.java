...
package org.hifnawy.base.providers.media;
...
import org.hifnawy.base.BuildConfig;
...
import org.hifnawy.base.providers.media.response.TVDetailsReponse;
import org.hifnawy.base.providers.media.response.TVResponse;
...
public class TVProvider extends MediaProvider {
    ...
    public ArrayList<Media> getResponseFormattedList(String responseStr, ArrayList<Media> currentList) throws IOException {
        ...
        List<org.hifnawy.base.providers.media.response.models.shows.Show> list = mapper.readValue(responseStr, mapper.getTypeFactory().constructCollectionType(List.class, org.hifnawy.base.providers.media.response.models.shows.Show.class));
        if (!list.isEmpty()) {
