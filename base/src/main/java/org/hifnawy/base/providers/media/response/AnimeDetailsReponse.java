...
import org.hifnawy.base.providers.media.response.models.anime.AnimeDetails;
import org.hifnawy.base.providers.media.response.models.anime.Episode;
    ...
    public ArrayList<Media> formatDetailForPopcorn(AnimeDetails item, MediaProvider mediaProvider, SubsProvider subsProvider) {
        ...
        try {
            ...
            if (item.getType().equalsIgnoreCase("show")) {
                ...
                SparseArray<org.hifnawy.base.providers.media.models.Episode> episodeMap = new SparseArray<>();
