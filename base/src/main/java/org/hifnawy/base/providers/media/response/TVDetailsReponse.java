...
import org.hifnawy.base.providers.media.response.models.DetailsResponse;
import org.hifnawy.base.providers.media.response.models.common.Quality;
import org.hifnawy.base.providers.media.response.models.shows.Episode;
import org.hifnawy.base.providers.media.response.models.shows.ShowDetails;
import org.hifnawy.base.providers.subs.SubsProvider;
import org.hifnawy.base.utils.StringUtils;
        ...
        try {
            ...
            if (item.getStatus() != null) {
                ...
                if (status.equalsIgnoreCase("ended")) {
                    show.status = org.hifnawy.base.providers.media.models.Show.Status.ENDED;
                } else if (status.equalsIgnoreCase("returning series")) {
                    show.status = org.hifnawy.base.providers.media.models.Show.Status.CONTINUING;
                } else if (status.equalsIgnoreCase("in production")) {
                    show.status = org.hifnawy.base.providers.media.models.Show.Status.CONTINUING;
                } else if (status.equalsIgnoreCase("canceled")) {
                    show.status = org.hifnawy.base.providers.media.models.Show.Status.CANCELED;
                }
            }
            ...
            for (Episode episode : item.getEpisodes()) {
                try {
                    org.hifnawy.base.providers.media.models.Episode episodeObject = new org.hifnawy.base.providers.media.models.Episode();
