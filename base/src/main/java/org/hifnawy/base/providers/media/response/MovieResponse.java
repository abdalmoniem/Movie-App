...
import org.hifnawy.base.providers.media.response.models.movies.Language;
import org.hifnawy.base.providers.media.response.models.movies.Movie;
import org.hifnawy.base.providers.media.response.models.movies.Quality;
...
public class MovieResponse extends Response<Movie> {
    ...
    public ArrayList<Media> formatListForPopcorn(ArrayList<Media> existingList, MediaProvider mediaProvider, SubsProvider subsProvider) {
        for (Movie item : responseItems) {
            ...
            org.hifnawy.base.providers.media.models.Movie movie = new org.hifnawy.base.providers.media.models.Movie();
